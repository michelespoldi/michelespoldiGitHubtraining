 ...
 */
func bestFriendName() {
    let mybestFriendName = "Jack Bauer"
    print(mybestFriendName)
}
 ...
 */
func personalisedGreeting (name: String) {
    print("Hello \(name)!")
}

personalisedGreeting(name: "Kate")
personalisedGreeting(name: "Barbara")
personalisedGreeting(name: "Sonia")

/*: question4
 ### 4. Now call the function you wrote in Question 3 using a variable or constant instead of a string literal. What do you expect to see in the console? Try passing in a _variable_ you declared (using `var`) as an argument. Then change that variable's value and call your function again. What do you see in the console?
 */
let myMum = "Liz"
personalisedGreeting(name: myMum)
...
//impossible to change eveb a variable as it is inside the function body
